  ...
  <body>
    <div class="container">
      ...
      <form class="form-signin" action="${pageContext.request.contextPath}/login" method="POST">
        ...
        <input type="email" id="inputEmail" name="user_id" class="form-control" value="park" placeholder="Email address" required autofocus>
        <label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" name="password" class="form-control" value="1234" placeholder="Password" required>
        <div class="checkbox">
          <label>
