	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<form id="boardInsert" class="form-horizontal" role="form" enctype="multipart/form-data" method="POST" action="${cp}/boardGInsert">
					...
					<div class="form-group">
						<div class="col-sm-10">
							<input type="hidden" name="board_group_no" value="${board_group_no}"/>
						</div>
					</div>
